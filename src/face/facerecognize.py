...
def video_reg():
    ...
    with tf.Graph().as_default():
        ...
        training([], [], [], [], keys, values, images_holder, labels_holder, l, e, sess=sess, reload=True, model_file="model/expression_cnn_withdrop")
        ...
        while True:
            ...
            if not rect is None:
                ...
                cv2.normalize(L, L_, 0, 1, cv2.NORM_MINMAX)

                X = [L_.reshape((80, 80, 1))/255]
                feed_dict = {images_holder: X, keys["keep_prob"]:1.0}
